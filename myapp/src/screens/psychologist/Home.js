	...
	return(
		<View>
          ...
          />
					...
					<Text style={styles.text}>Através da plataforma você podera encontrar novos pacientes.</Text>
					...
					<Text style={styles.text}>-Verifique quais pacientes mostraram enterece em uma consulta pelo botão <Text style={styles.textBold}>Pacientes</Text></Text>
